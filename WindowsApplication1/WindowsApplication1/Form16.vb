Public Class Form16
    ...
    Private Sub LoadNewHighscore()
        ...
        If Form9.playerscorecountMM >= Val(PlayerHighscore1st.Text) Then
            Highscore1 = Form9.playerscorecountMM
            ...
            FileNum = FreeFile()
            FileOpen(FileNum, "scoreMM.txt", OpenMode.Output)
            ...
            FileClose(FileNum)
        ElseIf Form9.playerscorecountMM >= Val(PlayerHighscore2nd.Text) Then
            Highscore1 = PlayerHighscore1st.Text
            Player1 = Player1st.Text
            Highscore2 = Form9.playerscorecountMM
            ...
            PrintLine(FileNum, Highscore3)
            FileClose(FileNum)
        ElseIf Form9.playerscorecountMM >= Val(PlayerHighscore3rd.Text) Then
            Highscore1 = PlayerHighscore1st.Text
            Player1 = Player1st.Text
            Highscore2 = PlayerHighscore2nd.Text
            Player2 = Player2nd.Text
            Highscore3 = Form9.playerscorecountMM
    ...
    Public Sub LoadCurrentHighScore()
        Dim FileNum As Integer
        FileNum = FreeFile()
        FileOpen(FileNum, "scoreMM.txt", OpenMode.Input)
