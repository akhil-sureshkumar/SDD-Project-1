Public Class Form8
    ...
    Dim timercount As Integer = 180
    Dim problemtimercount As Integer = 20
    Dim problemcount As Integer = 0
    Public playerscorecountEM As Integer = 0
    ...
    Private Sub Timer1_Tick(sender As Object, e As EventArgs) Handles Timer1.Tick
        ...
        If timercount = 0 Then
            ...
            playerscorecountEM = correctcount - incorrectcount
