Public Class Form10
    ...
    Dim timercount As Integer = 300
    Dim problemtimercount As Integer = 40
    Dim problemcount As Integer = 0
    Public playerscorecountHM As Integer = 0
    ...
    Private Sub Timer1_Tick(sender As Object, e As EventArgs) Handles Timer1.Tick
        ...
        If timercount = 0 Then
            ...
            playerscorecountHM = correctcount - incorrectcount
