Public Class Form13
    ...
    Private Sub LoadNewHighscore()
        ...
        If Form3.playerscorecountMA >= Val(PlayerHighscore1st.Text) Then
            Highscore1 = Form3.playerscorecountMA
            ...
            FileNum = FreeFile()
            FileOpen(FileNum, "scoreMA.txt", OpenMode.Output)
            ...
            FileClose(FileNum)
        ElseIf Form3.playerscorecountMA >= Val(PlayerHighscore2nd.Text) Then
            Highscore1 = PlayerHighscore1st.Text
            Player1 = Player1st.Text
            Highscore2 = Form3.playerscorecountMA
            ...
            PrintLine(FileNum, Highscore3)
            FileClose(FileNum)
        ElseIf Form3.playerscorecountMA >= Val(PlayerHighscore3rd.Text) Then
            Highscore1 = PlayerHighscore1st.Text
            Player1 = Player1st.Text
            Highscore2 = PlayerHighscore2nd.Text
            Player2 = Player2nd.Text
            Highscore3 = Form3.playerscorecountMA
    ...
    Public Sub LoadCurrentHighScore()
        Dim FileNum As Integer
        FileNum = FreeFile()
        FileOpen(FileNum, "scoreMA.txt", OpenMode.Input)
