Public Class Form14
    ...
    Private Sub LoadNewHighscore()
        ...
        If Form4.playerscorecountHA >= Val(PlayerHighscore1st.Text) Then
            Highscore1 = Form4.playerscorecountHA
            ...
            FileNum = FreeFile()
            FileOpen(FileNum, "scoreHA.txt", OpenMode.Output)
            ...
            FileClose(FileNum)
        ElseIf Form4.playerscorecountHA >= Val(PlayerHighscore2nd.Text) Then
            Highscore1 = PlayerHighscore1st.Text
            Player1 = Player1st.Text
            Highscore2 = Form4.playerscorecountHA
            ...
            PrintLine(FileNum, Highscore3)
            FileClose(FileNum)
        ElseIf Form4.playerscorecountHA >= Val(PlayerHighscore3rd.Text) Then
            Highscore1 = PlayerHighscore1st.Text
            Player1 = Player1st.Text
            Highscore2 = PlayerHighscore2nd.Text
            Player2 = Player2nd.Text
            Highscore3 = Form4.playerscorecountHA
    ...
    Public Sub LoadCurrentHighScore()
        Dim FileNum As Integer
        FileNum = FreeFile()
        FileOpen(FileNum, "scoreHA.txt", OpenMode.Input)
