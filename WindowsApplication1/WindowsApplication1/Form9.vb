Public Class Form9
    ...
    Dim timercount As Integer = 240
    Dim problemtimercount As Integer = 30
    Dim problemcount As Integer = 0
    Public playerscorecountMM As Integer = 0
    ...
    Private Sub Timer1_Tick(sender As Object, e As EventArgs) Handles Timer1.Tick
        ...
        If timercount = 0 Then
            ...
            playerscorecountMM = correctcount - incorrectcount
