Public Class Form12
    ...
    Private Sub LoadNewHighscore()
        ...
        If Form2.playerscorecountEA >= Val(PlayerHighscore1st.Text) Then
            Highscore1 = Form2.playerscorecountEA
            ...
            FileNum = FreeFile()
            FileOpen(FileNum, "scoreEA.txt", OpenMode.Output)
            ...
            FileClose(FileNum)
        ElseIf Form2.playerscorecountEA >= Val(PlayerHighscore2nd.Text) Then
            Highscore1 = PlayerHighscore1st.Text
            Player1 = Player1st.Text
            Highscore2 = Form2.playerscorecountEA
            ...
            PrintLine(FileNum, Highscore3)
            FileClose(FileNum)
        ElseIf Form2.playerscorecountEA >= Val(PlayerHighscore3rd.Text) Then
            Highscore1 = PlayerHighscore1st.Text
            Player1 = Player1st.Text
            Highscore2 = PlayerHighscore2nd.Text
            Player2 = Player2nd.Text
            Highscore3 = Form2.playerscorecountEA
    ...
    Public Sub LoadCurrentHighScore()
        Dim FileNum As Integer
        FileNum = FreeFile()
        FileOpen(FileNum, "scoreEA.txt", OpenMode.Input)
